\documentclass[a4paper,twocolumn,12pt]{ltjsarticle}
\input{preamble}
\makeatletter
\def\section{\vfill\eject\@startsection {section}{1}{\z@}{-3.5ex plus -1ex minus -.2ex}{2.3 ex plus .2ex}{\Large\bf}}
\makeatother
...
\begin{description}
    ...
    \item[定缺] 使わない色を配牌時に裏向きに打牌。競技会ではこの指定は萬・筒・索のカードによって行うことが望ましい。
